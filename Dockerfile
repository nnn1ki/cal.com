...
ARG NEXT_PUBLIC_DEMO_ADMIN_BOOKING_URL
ARG NEXT_PUBLIC_DEMO_ADMIN_PUBLIC_PAGE_URL
ARG NEXT_PUBLIC_DEMO_ADMIN_USERNAME
ARG CSP_POLICY
...
ENV NEXT_PUBLIC_WEBAPP_URL=http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER \
    ...
    NEXT_PUBLIC_DEMO_ADMIN_BOOKING_URL=$NEXT_PUBLIC_DEMO_ADMIN_BOOKING_URL \
    NEXT_PUBLIC_DEMO_ADMIN_PUBLIC_PAGE_URL=$NEXT_PUBLIC_DEMO_ADMIN_PUBLIC_PAGE_URL \
    NEXT_PUBLIC_DEMO_ADMIN_USERNAME=$NEXT_PUBLIC_DEMO_ADMIN_USERNAME \
