...
export function ManageLink(props: { calEvent: CalendarEvent; attendee: Person }) {
  ...
  try {
    ...
    rescheduleLink = getRescheduleLink({ calEvent: props.calEvent, attendee: props.attendee });
    bookingLink = getBookingUrl({
      platformClientId: props.calEvent.platformClientId,
    ...
    console.error("Failed to build booking management links for confirmation email", {
