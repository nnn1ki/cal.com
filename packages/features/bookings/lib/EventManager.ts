...
export default class EventManager {
  ...
  public async create(
    ...
    // Resource bookings in this fork are treated as in-person even when no explicit location was configured.
    // Avoid auto-generating a video link for them.
    if (!evt.location && !evt.bookableResourceId) {
